...
public class Facade implements IFacade {
	...
	public boolean isCarryingLog(Unit unit) throws ModelException {
		if (unit.isCarrying())
			return unit.getCarryable().getCarryableType() == CarryableType.LOG;
		return false;
	}
	...
	public boolean isCarryingBoulder(Unit unit) throws ModelException {
		if (unit.isCarrying())
			return unit.getCarryable().getCarryableType() == CarryableType.BOULDER;
		return false;
	}
	...
	public Iterator<Task> getAllTasksIterator(Scheduler scheduler)
			throws ModelException {
		return scheduler.getPriorityIterator();
	}
